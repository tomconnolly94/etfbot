...
docker run --mount source=etfbot-db-volume,target=/db --mount source=etfbot-logs-volume,target=/var/log/etfbot/ -p 8080:8080 --restart unless-stopped --name etfbot -d etfbot:latest
