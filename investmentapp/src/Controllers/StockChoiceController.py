...
from investmentapp.src.Strategies.StockChoiceStrategies.LinearWeightingStrategyCheapFirst import (
    LinearWeightingStrategyCheapFirst,
)
from investmentapp.src.Strategies.StockChoiceStrategies.LinearWeightingStrategyExpensiveFirst import (
    LinearWeightingStrategyExpensiveFirst,
)
